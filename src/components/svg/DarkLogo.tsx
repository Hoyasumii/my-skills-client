...
export function DarkLogo({
	...
	return (
		<svg
			...
			className={className}
		>
			<rect width="512" height="512" rx="256" fill="url(#paint0_linear_16_2)" />
			<circle cx="256" cy="256" r="241" fill="#0C0A09" />
			<circle
				cx="256"
				cy="256"
				r="241"
				fill="url(#pattern0_16_2)"
				fillOpacity="0.2"
			/>
			<circle
				cx="256"
			...
			<defs>
				<pattern
					...
					height="0.06639"
				>
					<use xlinkHref="#image0_16_2" transform="scale(0.00103734)" />
				</pattern>
				<filter
					id="filter0_i_16_2"
					x="284"
				...
				>
					...
					<feBlend
						mode="normal"
						in2="shape"
						result="effect1_innerShadow_16_2"
					/>
				</filter>
				<filter
					id="filter1_i_16_2"
